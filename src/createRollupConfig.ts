...
import { babelPluginKaots } from './babelPluginKaots';
import { KaotsOptions } from './types';
...
export async function createRollupConfig(
  ...
  return {
    ...
    treeshake: {
      ...
      // This means kaots WILL remove getters and setters defined directly on objects.
